...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  // Select the User_Name, User_Password, and ID from the interns table, comparing case sensitively
  $sql = "SELECT email, password, id FROM interns WHERE BINARY email=? AND BINARY password=?";
  ...
  <div class="login-wrapper">
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?> " method="POST" class="form">
      ...
      <a href="#forgot-pw" class="forgot-pw">
        <h4 class="primary-variant">Forgot Password?</h4>
      </a>
    </form>
    <center>
      <div id="forgot-pw">
